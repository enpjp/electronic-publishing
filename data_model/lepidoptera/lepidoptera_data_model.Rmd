...
datumList <- list(
  ...
  "site" = "Site",
  "VC" = "Vice County",
  "grid.ref" = "UK Cgrid reference",
  "recorder.name" = "Recorder name",
  "comments" = "General comments",
  "determiner" = "Determiner",
  "method" = "Method of collection",
  "stage" = "Specimen life stage",
  "quantity" = "Number of specimens recorded",
  "order" = "Order" ,
  "family" = "Family",
  "sub.family" = "Sub Family",
  "genus" = "Genus",
  "taxon" = "Taxon",
  "log.number" = "EU log number",
  "Code"= "BF code",
  ...
  labelcommon.name <- dataLabelTemp$datumValue[
    which( dataLabelTemp$datumAttribute == 'vernacular')]
...
```{r  eval=TRUE,  include=TRUE, echo=FALSE, fig.align='center', fig.show='hold', fig.cap= paste(sectionTitle, paste(sectionTitle, 'Specimen images', sep = " ") , sep = " ")  }
